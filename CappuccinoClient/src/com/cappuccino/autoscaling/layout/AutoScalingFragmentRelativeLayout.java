...
public class AutoScalingFragmentRelativeLayout extends RelativeLayout implements
		AutoScalingFragmentLayout {

	private AutoScalingManager asm;

	public AutoScalingFragmentRelativeLayout(Context context) {
		this(context, null);
	}

	public AutoScalingFragmentRelativeLayout(Context context, AttributeSet attrs) {

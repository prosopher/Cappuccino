...
public class AutoScalingLinearLayout extends LinearLayout {

	private AutoScalingManager asm;

	public AutoScalingLinearLayout(Context context) {
		this(context, null);
	}

	public AutoScalingLinearLayout(Context context, AttributeSet attrs) {

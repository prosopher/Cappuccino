...
public class AutoScalingFragmentLinearLayout extends LinearLayout implements
		AutoScalingFragmentLayout {

	private AutoScalingManager asm;

	public AutoScalingFragmentLinearLayout(Context context) {
		this(context, null);
	}

	public AutoScalingFragmentLinearLayout(Context context, AttributeSet attrs) {

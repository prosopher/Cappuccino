...
public class ByteUtil {
	...
	public static byte[] intToBytes(int inInt) {
		return new byte[] { (byte) ((inInt >> 24) & 0xFF), (byte) ((inInt >> 16) & 0xFF), (byte) ((inInt >> 8) & 0xFF),
				(byte) (inInt & 0xFF) };
	}
	...
	public static int bytesToInt(byte[] inBytes, int offset) {
		...
		return inBytes[offset + 3] & 0xFF | (inBytes[offset + 2] & 0xFF) << 8 | (inBytes[offset + 1] & 0xFF) << 16
	...
	public static byte[] longToBytes(long inLong) {
		return new byte[] { (byte) ((inLong >> 56) & 0xFF), (byte) ((inLong >> 48) & 0xFF),
				(byte) ((inLong >> 40) & 0xFF), (byte) ((inLong >> 32) & 0xFF), (byte) ((inLong >> 24) & 0xFF),
				(byte) ((inLong >> 16) & 0xFF), (byte) ((inLong >> 8) & 0xFF), (byte) (inLong & 0xFF) };
	}
	...
	public static int bytesToLong(byte[] inBytes, int offset) {
		...
		return inBytes[offset + 7] & 0xFF | (inBytes[offset + 6] & 0xFF) << 8 | (inBytes[offset + 5] & 0xFF) << 16
				| (inBytes[offset + 4] & 0xFF) << 24 | (inBytes[offset + 3] & 0xFF) << 32
				| (inBytes[offset + 2] & 0xFF) << 40 | (inBytes[offset + 1] & 0xFF) << 48
	...
	public static Deserializable deserializeWithArgs(byte[] objBytes, Object... args) {
